...
from app.cognition.relationships.extractor import (
...
class UnderstandingProcessor(Processor[str, Understanding]):
    ...
    def __init__(
        ...
        self._relationship_extractor = (
            relationship_extractor
            or RelationshipExtractor()
        )

        self._emotion_extractor = (
            emotion_extractor or EmotionExtractor()
        )

        self._date_extractor = (
            date_extractor or DateExtractor()
        )

        self._time_extractor = (
            time_extractor or TimeExtractor()
        )

        self._duration_extractor = (
            duration_extractor or DurationExtractor()
        )
    ...
    def process(
        ...
        return Understanding(
            ...
            relationships=self._relationship_extractor.process(
                data
            ),
